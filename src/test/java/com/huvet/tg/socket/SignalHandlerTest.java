...
public class SignalHandlerTest {
    ...
    public void shouldRemoveClient_whenConnectionClosed() throws Exception {
        ...
        WebSocketMessage message = new WebSocketMessage(name,"join", room.getId().toString(), null, null, null);
        handler.handleTextMessage(session, new TextMessage(ow.writeValueAsString(message)));
        message = new WebSocketMessage(name, "leave", room.getId().toString(), null, null, null);
        handler.handleTextMessage(session, new TextMessage(ow.writeValueAsString(message)));
